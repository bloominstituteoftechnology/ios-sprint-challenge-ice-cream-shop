...
//eat(flavor: Flavor(name: "Cookie", rating: 5), topping: "", size: .medium)
...
orderCone(flavor: iceCreamShop.flavors[0], topping: "", size: .small)
...
orderCone(flavor: strawberry, topping: "", size: .medium)
